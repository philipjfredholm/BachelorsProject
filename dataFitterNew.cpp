...
int main(int argc, char **argv) {
    ...
    for (int ptNumber = 0; ptNumber < static_cast<int>(dataVectorForward.size()); ptNumber++) {
        ...
        for (int centralityNumber = 0; centralityNumber < static_cast<int>(dataVectorForward[0].size()); centralityNumber++) { 
            ...
            for (int pull = 0; pull < numberOfDraws; pull++) {
                ...
                std::cout << background.GetBinContent(5) << std::endl;
            ...
            std::cout << "backward over" << std::endl;
            //BackToBack
            if (ptNumber == 0 ) {
            ...
            std::cout << "backtoback over " << std::endl;
    ...
    std::cout << "par1t 1 done " << std::endl;
    ...
    //Saves the data
    std::cout << v2BackwardFinalList[6][0] << std::endl;
